...
public interface Organization {
  ...
  /**
   * Adds a new employee to a node.
   * @param newEmployee Takes in an employee object that already has established name,pay,gender
   * @param supervisorName Takes in supervisors name.
   */
  void addEmployee(Employee newEmployee, String supervisorName);
